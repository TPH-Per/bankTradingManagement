import { Home, ArrowLeftRight, Users, BarChart, Settings, CircleDollarSign, HardDrive, Activity, TrendingUp } from 'lucide-static';
...
const navItems = [
  ...
  { path: '/hdfs', label: 'HDFS Storage', icon: HardDrive },
